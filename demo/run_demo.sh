...
echo "Running LTAW demo.."
eval "$(conda shell.bash hook)"
conda activate ltaw
python demo_ltaw.py --weight $model_ckpt --input $input
# To save the input video and output match visualizations.
# python demo_ltaw.py --weight $model_ckpt --input $input --save_video --save_input

# Running on remote GPU servers with no GUI.
# Save images first.
# python demo_ltaw.py --weight $model_ckpt --input $input --no_display --output_dir="./demo_images/"
